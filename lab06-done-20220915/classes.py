...
class Player(object):
    ...
    def talk_to(self, person):
        ...
        if type(person) != str:
            ...
            print("{} says: {}" .format(person,self.place.characters[person].message))
    ...
    def take(self, thing):
        ...
        if type(thing) != str:
            ...
            print('Player takes the', self.place.things[thing].name)
            del self.place.things[self.place.things[thing].name]
